...
def test_production_with_default_secret_key_raises(monkeypatch: pytest.MonkeyPatch) -> None:
...
def test_development_with_default_secret_key_is_fine(monkeypatch: pytest.MonkeyPatch) -> None:
